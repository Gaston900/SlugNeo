...
INPUT_PORTS_START( mslug2wp )
    ...
    PORT_BIT( 0x8200, IP_ACTIVE_LOW, IPT_BUTTON7 ) PORT_NAME("@P1 Weapon Change @Button7") PORT_CONDITION("DSW", 0xF000, NOTEQUALS, 0x8200) PORT_CODE(KEYCODE_E)
	
	PORT_MODIFY("P2")
	PORT_BIT( 0x8100, IP_ACTIVE_LOW, IPT_BUTTON6 ) PORT_PLAYER(2) PORT_NAME("@P2 Body Change @Button6") PORT_CONDITION("P2", 0xF000, NOTEQUALS, 0x8100) PORT_CODE(KEYCODE_W)
    PORT_BIT( 0x8200, IP_ACTIVE_LOW, IPT_BUTTON7 ) PORT_PLAYER(2) PORT_NAME("@P2 Weapon Change @Button7") PORT_CONDITION("P2", 0xF000, NOTEQUALS, 0x8200) PORT_CODE(KEYCODE_E)
INPUT_PORTS_END
...
INPUT_PORTS_START( mslug2cq )
	PORT_INCLUDE( mslug2sc )

	PORT_MODIFY("DSW")
	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_BUTTON4 ) PORT_NAME("@P1 Enable Random Enemy @Button4") PORT_CONDITION("DSW", 0xF000, NOTEQUALS, 0x8000) PORT_CODE(KEYCODE_Z)
	...
	PORT_BIT( 0x0110, IP_ACTIVE_LOW, IPT_BUTTON4 ) PORT_NAME("@P1 Enable Random Enemy @Button4") PORT_CONDITION("SYSTEM", 0x0110, EQUALS, 0x0110) PORT_CODE(KEYCODE_Z)
INPUT_PORTS_END
...
INPUT_PORTS_START( mslug2sd )
	...
	PORT_BIT( 0x4400, IP_ACTIVE_LOW, IPT_BUTTON6 ) PORT_NAME("@P1 Body Change Player Normal @Button6") PORT_CONDITION("DSW", 0xF000, NOTEQUALS, 0x4400) PORT_CODE(KEYCODE_W)
    PORT_BIT( 0x4100, IP_ACTIVE_LOW, IPT_BUTTON7 ) PORT_NAME("@P1 Body Change Player Mummy @Button7") PORT_CONDITION("DSW", 0xF000, NOTEQUALS, 0x4100) PORT_CODE(KEYCODE_E)
	PORT_BIT( 0x4200, IP_ACTIVE_LOW, IPT_BUTTON8 ) PORT_NAME("@P1 Body Change Player Fat @Button8") PORT_CONDITION("DSW", 0xF000, NOTEQUALS, 0x4200) PORT_CODE(KEYCODE_R)
INPUT_PORTS_END

INPUT_PORTS_START( mslug2sdi )
	PORT_INCLUDE( mslug2sc )
...
#define MSLUG2WC_CUZTOMESSENTIALPATCH_MODS_FILL \
    MSLUG2_SPEEDUPLEVELTEXTLEVEL_MODS_FILL \
    MSLUG2_STARTWALKINGALLLEVELS_MODS_FILL \
    MSLUG2_SOLDIERDOESNTDISAPPEARWHENHEDIES_MODS_FILL \
    MSLUG2_FLASHOFF_MODS_FILL \
	...
	MSLUG2_SOLDIERSHIELD_CHANGING_UNIFORM_MODS_FILL \
	MSLUG2_DEBUGMENUENGLISHTRANSLATION_MODS_FILL \
	MSLUG2_DISABLEMODTURBOV2_MODS_FILL \
	MSLUG2_MVS_FILL \
    MSLUG2_AES_FILL
...
#define MSLUG2_DISABLEMODTURBOV2_MODS_FILL \
    ROM_FILL(0x11F7,1,0x20)\
	ROM_FILL(0x11F8,1,0x20)\
	ROM_FILL(0x11F9,1,0x20)\
	ROM_FILL(0x11FA,1,0x20)\
...
#define MSLUG2EG_NEOSD \
    ...
    NEO_SFIX_MT(0x20000)\
	ROM_COPY("asis", 0x400000, 0x00000, 0x20000)\
	ROM_REGION( 0x800000, "ymsnd", 0 )\
...
ROM_START( mslug2ctma10 )
	...
	ROM_LOAD16_WORD_SWAP( "256_cmb03.p2", 0x100000, 0x200000, CRC(d37e26cd) SHA1(4b71884a1fda67323ce3b953801bf01aa6f56ed9) )
    MSLUG2WC_CUZTOMESSENTIALPATCH_MODS_FILL
	MSLUG2_SFIX_128K
    MSLUG2_AUDIO_128K
    MSLUG2_YMSND
    MSLUG2_SPRITES
...
GAME( 2025, mslug2rmb01,      mslug2,   neoclock_noslot, mslug2sd,   neogeo_state,    init_neogeo,     ROT0, "PSMSlugForever",  "Metal Slug 2 (Enemies Resetting XR Remix Extreme 2025-02-25)", MACHINE_SUPPORTS_SAVE )
GAME( 2025, mslug2rmb02,      mslug2,   neoclock_noslot, mslug2sdi,  neogeo_state,    init_neogeo,     ROT0, "PSMSlugForever",  "Metal Slug 2 (Enemies Resetting XR Survival Remix Extreme 2025-02-25)", MACHINE_SUPPORTS_SAVE ) //To enable Mods random you need to apply a command you have to press the Stars + D button to change Stars + C.
